...
game.levels.createLevels = function () {
  ...
  game.levels.push({
        _backgrounds:[{_id:'A',_width:1300,_height:750,X:3000,Y:-100,_scrollRatio:0,_fillStyle:game.patterns.violetBkg1},
                      ...
                      {_id:'E',_width:1000,_height:200,X:350,Y:-300,_scrollRatio:1,_fillStyle:game.patterns.blueBlockDiagonal}],
        _platforms:[{_id:'1',_width:3900,_height:300,X:0,Y:0,_fillStyle:game.patterns.violetBlockLosangeBeziers1},
                    ...
                    {_id:'4',_width:1440,_height:180,X:0,Y:-270,_fillStyle:game.patterns.violetBlockLosangeBeziers2,_radiusStyle:[0,10]},
                    ...
                    {_id:'9',_width:1000,_height:30,X:-150,Y:-430,_fillStyle:game.patterns.violetBlock},
                    {_id:'10',_width:180,_height:30,X:1000,Y:-490,_fillStyle:game.patterns.violetBlockCircle,_radiusStyle:10},
                    {_id:'11',_width:990,_height:300,X:-510,Y:-700,_fillStyle:game.patterns.violetBlock,_strokeStyle:'#582970'},
                    {_id:'12',_width:180,_height:30,X:480,Y:-640,_fillStyle:game.patterns.violetBlock,_strokeStyle:'#582970'},
                    {_id:'12bis',_width:90,_height:10,X:527,Y:-610,_fillStyle:'#d10c0c',_actionable:{_message:'PLTF_DESTROY:8'},_radiusStyle:[0,0,10,10]}],
        ...
        _numbers:[{_id:'56',X:1400,Y:-306,
                  ...
                  _bodyFill:'#0565a4',_textFill:'#0565a4'}],
