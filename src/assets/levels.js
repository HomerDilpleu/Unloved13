...
game.levels.createLevels = function () {
  ...
  game.levels.push({
    ...
    _platforms:[{_id:'1',_width:210,_height:30,X:2000,Y:3000,_fillStyle:'#582970'},
                {_id:'2',_width:400,_height:30,X:2300,Y:2900,_fillStyle:'#582970'},
                {_id:'3',_width:30,_height:930,X:2510,Y:2400,_fillStyle:'#582970'},
                {_id:'4',_width:530,_height:30,X:2300,Y:3100,_fillStyle:'#582970'},
                {_id:'5',_width:60,_height:60,X:2680,Y:3050,_fillStyle:'red'},
                {_id:'6',_width:210,_height:30,X:2000,Y:3200,_fillStyle:'#582970'},
                {_id:'7',_width:210,_height:30,X:2300,Y:3300,_fillStyle:'#582970'},
                {_id:'8',_width:30,_height:3000,X:2800,Y:560,_fillStyle:'#582970'},
                {_id:'9',_width:1630,_height:300,X:1200,Y:3530,_fillStyle:'#582970'},
                {_id:'10',_width:210,_height:30,X:2000,Y:3400,_fillStyle:'#582970'},
                {_id:'11',_width:210,_height:30,X:2000,Y:2800,_fillStyle:'#582970'},
                {_id:'12',_width:210,_height:30,X:2300,Y:2700,_fillStyle:'#582970'},
                {_id:'13',_width:210,_height:30,X:2300,Y:2500,_fillStyle:'#582970'},
                {_id:'14',_width:120,_height:10,X:2350,Y:2530,_fillStyle:'#d10c0c',_radiusStyle:[0,0,10,10],_actionable:{_message:'PLTF_MOVE:16'}},
                {_id:'16',_width:210,_height:30,X:2000,Y:3000,_fillStyle:'#582970',_movesTo:{X:1750,Y:3000,_velocityX:-50,_velocityY:0}},
                {_id:'17',_width:210,_height:30,X:1500,Y:3000,_fillStyle:'#582970'},
                {_id:'18',_width:210,_height:30,X:1200,Y:2900,_fillStyle:'#582970'},
                {_id:'19',_width:210,_height:30,X:1500,Y:2800,_fillStyle:'#582970'},
                {_id:'20',_width:210,_height:30,X:1200,Y:2700,_fillStyle:'#582970'},
                {_id:'21',_width:640,_height:30,X:1500,Y:2600,_fillStyle:'#582970'},
                {_id:'22',_width:30,_height:3000,X:1200,Y:560,_fillStyle:'#582970'},
                {_id:'23',_width:210,_height:30,X:1200,Y:2500,_fillStyle:'#582970'},
                {_id:'24',_width:500,_height:30,X:1500,Y:2400,_fillStyle:'#582970'},
                {_id:'25',_width:30,_height:120,X:1970,Y:2280,_fillStyle:'red',_pushable:{_Xmin:2015,_Xmax:2125,_Xfall:2015,_Yfall:2540,_fallSide:'right'}}],
