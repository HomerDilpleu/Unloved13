...
game.levels.createLevels = function () {
  ...
  game.levels.push({
        _backgrounds:[{_id:'1',_width:1300,_height:750,X:3000,Y:-100,_scrollRatio:0,_fillStyle:game.patterns.level1Background1},
                      {_id:'2',_width:5000,_height:1500,X:3000,Y:-550,_scrollRatio:0.5,_fillStyle:game.patterns.level1Background2},
                      {_id:'3',_width:7000,_height:1500,X:3000,Y:-500,_scrollRatio:0.75,_fillStyle:game.patterns.level1Background3},
...
//                    {_id:'3bi',_width:1800,_height:90,X:-30,Y:-60,_fillStyle:'#582970'},
                    {_id:'4',_width:1440,_height:180,X:0,Y:-270,_fillStyle:game.patterns.level1BlockGreat,_radiusStyle:[0,10]},
                    {_id:'5',_width:180,_height:30,X:1900,Y:-200,_fillStyle:game.patterns.level1BlockGreat,_radiusStyle:10},
                    ...
                    {_id:'8bis',_width:150,_height:25,X:1310,Y:-420,_actionable:{_message:'TEXT_BOX:IT SEEMS NUMBERS ARE AFRAID WHEN THEY SEE YOU:640:150'}},
